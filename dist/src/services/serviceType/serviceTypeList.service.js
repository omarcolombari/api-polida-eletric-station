...
const serviceTypeListService = () => __awaiter(void 0, void 0, void 0, function* () {
    const serviceTypeRepository = data_source_1.AppDataSource.getRepository(serviceType_entity_1.default);
    const serviceTypeList = yield serviceTypeRepository.find();
    return serviceTypeList;
});
exports.default = serviceTypeListService;
