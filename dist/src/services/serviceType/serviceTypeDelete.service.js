...
const serviceTypeDeleteService = (id) => __awaiter(void 0, void 0, void 0, function* () {
    const serviceTypeRepository = data_source_1.AppDataSource.getRepository(serviceType_entity_1.default);
    const service = yield serviceTypeRepository.findOne({ where: { id } });
    if (!service)
        throw new errors_1.AppError("Service not found", 404);
    yield serviceTypeRepository.delete(service.id);
    return true;
});
exports.default = serviceTypeDeleteService;
